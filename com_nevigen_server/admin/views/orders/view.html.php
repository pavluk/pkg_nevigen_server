...
class NevigenServerViewOrders extends HtmlView
{
    /**
    ...
    public function display($tpl = null)
    {
        ...
        // Prepare sidebar
        NevigenServerHelper::addSubmenu('orders');
    ...
    {
        $canDo   = NevigenServerHelper::getActions('com_nevigen_server', 'orders');
        $toolbar = Toolbar::getInstance();


        // Set page title
        ToolbarHelper::title(Text::_('COM_NEVIGEN_SERVER') . ': ' . Text::_('COM_NEVIGEN_SERVER_ORDERS'), 'cube');
        ...
        {
            ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'orders.delete', 'JTOOLBAR_EMPTY_TRASH');
        }
