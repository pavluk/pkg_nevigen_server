...
Factory::getDocument()->addScriptDeclaration('
	Joomla.submitbutton = function (task) {
		if (task == "extension.cancel" || document.formvalidator.isValid(document.getElementById("item-form"))) {
...
?>
<form action="<?php echo Route::_('index.php?option=com_nevigen_server&view=extension&id=' . $this->item->id); ?>"
    ...
    <?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'general', Text::_('COM_NEVIGEN_SERVER_EXTENSION')); ?>
